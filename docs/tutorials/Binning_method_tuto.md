...
**Example Script:** `docs/examples/contact_angle_binned/example_binned.py`
```python
"""
Example: Contact Angle Analysis Using the Binned Method

This example shows how to perform a binned contact angle analysis
on a LAMMPS dump trajectory using the hydroangleanalyzer library.
"""
...
# --- Step 3: Set up binning parameters ---
binning_params = {
    'xi_0': 0.0,
    'xi_f': 100.0,
    'nbins_xi': 50,
...
# --- Step 5: Create and run analyzer ---
analyzer = create_contact_angle_analyzer(
    method='binned',
    parser=parser,
    output_dir='results_binned_example',
