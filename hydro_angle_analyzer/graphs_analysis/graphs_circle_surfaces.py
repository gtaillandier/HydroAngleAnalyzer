...
def plot_surface_points(surface_file, popt_file, output_filename, limit_med=9.5):
    """
...
#     plot_surface_points(surface_file, popt_file, output_filename)
